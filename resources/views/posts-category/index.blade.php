            ...
            <div class="col-md-4">
                <div class="card p-1 category-item">
                    ...
                    <div>
                        ...
                        <a href="{{route('posts-category.edit',$postsCategory->id)}}" class="btn btn-secondary">Edit</a>
                        <form action="{{ route('posts-category.destroy', $postsCategory->id) }}" method="POST" onsubmit="return confirm('@lang('Are your shoure?')');" style="display: inline-block;">
